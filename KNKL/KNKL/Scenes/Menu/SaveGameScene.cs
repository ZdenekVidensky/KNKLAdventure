...
{
    public class SaveGameScene : CCScene
    {
        ...
        public SaveGameScene(CCWindow mainWindow) : base(mainWindow)
        {
            ...
            //Prvni slot
            CCSaveSlot slot1 = new CCSaveSlot("Save1", _mainWindow, true);
            ...
            //Druhy slot
            CCSaveSlot slot2 = new CCSaveSlot("Save2", _mainWindow, true);
            ...
            //Treti slot
            CCSaveSlot slot3 = new CCSaveSlot("Save3", _mainWindow, true);
            ...
            //Ctvrty slot
            CCSaveSlot slot4 = new CCSaveSlot("Save4", _mainWindow, true);
            ...
            //Paty slot
            CCSaveSlot slot5 = new CCSaveSlot("Save5", _mainWindow, true);
